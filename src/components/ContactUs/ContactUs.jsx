...
const ContactUs = () => {
  const developers = [
    ...
    {
      ImgSrc: "../../../public/images/rebecca1.jpg",
      alt: "pic",
      Name: "Rebecca Yang",
      job: "Developer",
    ...
    {
      ImgSrc: "../../../public/images/haoyu3.jpg",
      alt: "pic",
    ...
    {
      ImgSrc: "../../../public/images/erica.jpg",
      alt: "pic",
    ...
    {
      ImgSrc: "../../../public/images/tairan1.jpg",
      alt: "pic",
      Name: "Tairan Liang",
      job: "Developer",
  ...
  const dev = [
    ...
    {
      ImgSrc: "../../../public/images/author_icon.png",
      alt: "pic",
      Name: "Yunfeng Chen",
      job: "Devops",
